...
func (x *ListOrderOutput) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListOrderOutput) ProtoMessage() {}

func (x *ListOrderOutput) ProtoReflect() protoreflect.Message {
	mi := &file_internal_infra_grpc_protofiles_order_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListOrderOutput.ProtoReflect.Descriptor instead.
func (*ListOrderOutput) Descriptor() ([]byte, []int) {
	return file_internal_infra_grpc_protofiles_order_proto_rawDescGZIP(), []int{3}
}

func (x *ListOrderOutput) GetOrders() []*CreateOrderResponse {
	if x != nil {
		return x.Orders
	}
	return nil
...
var file_internal_infra_grpc_protofiles_order_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x50, 0x72, 0x69, 0x63, 0x65, 0x22, 0x42, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x12, 0x2f, 0x0a, 0x06, 0x6f, 0x72,
	...
	0x6e, 0x73, 0x65, 0x52, 0x06, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x32, 0x7c, 0x0a, 0x0c, 0x4f,
	...
	0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2c, 0x0a, 0x0a, 0x4c,
	0x69, 0x73, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x12, 0x09, 0x2e, 0x70, 0x62, 0x2e, 0x62,
	0x6c, 0x61, 0x6e, 0x6b, 0x1a, 0x13, 0x2e, 0x70, 0x62, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72,
	0x64, 0x65, 0x72, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x42, 0x18, 0x5a, 0x16, 0x69, 0x6e, 0x74,
...
var file_internal_infra_grpc_protofiles_order_proto_goTypes = []interface{}{
	...
	(*ListOrderOutput)(nil),     // 3: pb.ListOrderOutput
}
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	2, // 0: pb.ListOrderOutput.orders:type_name -> pb.CreateOrderResponse
	...
	3, // 4: pb.OrderService.ListOrders:output_type -> pb.ListOrderOutput
