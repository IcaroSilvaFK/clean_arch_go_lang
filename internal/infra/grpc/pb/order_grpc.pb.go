...
type OrderServiceClient interface {
	...
	ListOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*ListOrderOutput, error)
}
...
func (c *orderServiceClient) ListOrders(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*ListOrderOutput, error) {
	out := new(ListOrderOutput)
...
type OrderServiceServer interface {
	...
	ListOrders(context.Context, *Blank) (*ListOrderOutput, error)
...
func (UnimplementedOrderServiceServer) ListOrders(context.Context, *Blank) (*ListOrderOutput, error) {
